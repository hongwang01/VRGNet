...
parser.add_argument("--data_path",type=str, default="./data/spa-data/test/small/rain",help='path to testing rainy images')
parser.add_argument('--stage', type=int, default=6, help='the stage number of PReNet')
parser.add_argument("--use_gpu", type=bool, default=True, help='use GPU or not')
parser.add_argument("--gpu_id", type=str, default="0", help='GPU id')
parser.add_argument('--netDerain', default='./spamodels/DerainNet_state_800.pt', help="path to netDNet for deraining")
parser.add_argument('--save_path', default='./derained_results/spa-data/', help='folder to derained images')
