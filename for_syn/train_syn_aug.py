...
parser.add_argument('--netED', default='./syn100lmodels/ED_state_700.pt', help="trained generative model for augmetation")
parser.add_argument('--log_dir', default='./aug_syn100llogs/', help='tensorboard logs')
parser.add_argument('--model_dir',default='./aug_syn100lmodels/',help='saving model')
...
if __name__ == "__main__":
    ...
    # training data
    len_train_dataset = ceil(3000 * (opt.fake_ratio + 1))  # total num = original num + augmenatation num
    train_dataset = TrainDataset(opt.data_path, opt.gt_path, opt.patchSize, opt.batchSize * len_train_dataset)
    # train model
