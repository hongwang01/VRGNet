...
parser.add_argument("--data_path", type=str, default="./data/rain100L/test/small/rain",help='path to test data')
parser.add_argument("--model_dir", type=str, default="./aug_syn100lmodels/Aug_DerainNet_state_200.pt", help='path to model and log files')
parser.add_argument("--use_gpu", type=bool, default=True, help='use GPU or not')
parser.add_argument("--gpu_id", type=str, default="0", help='GPU id')
parser.add_argument("--save_path", type=str, default="./aug_derained_results/rain100L/", help='path to training data')
